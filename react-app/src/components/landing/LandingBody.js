    ...
    <div className="landing-main-body-container">
      ...
      <div className="landing-body-wrapper-2">
        <div className="lb-wrap-2">
            ...
            <p className="lb-2-p">A random paragraph place holder for people to see so that im going to keep typing in here to make this very long just to have some info space</p>
        </div>
      </div>
            {/* ****** section 3 ******* */}
      <div className="landing-body-wrapper-3">
        <div className="lb-wrap-3">
            <img src={logo} className="lb-3-img"/>
            <h2 className="lb-3-h2">A quick description about one dessert</h2>
            <p className="lb-3-p">A random paragraph place holder for people to see so that im going to keep typing in here to make this very long just to have some info space</p>
        </div>
      </div>
            {/* ****** section 4 ******* */}
      <div className="landing-body-wrapper-4">
        <div className="lb-wrap-4">
            <img src={logo} className="lb-4-img"/>
            <h2 className="lb-4-h2">A quick description about one dessert</h2>
            <p className="lb-4-p">A random paragraph place holder for people to see so that im going to keep typing in here to make this very long just to have some info space</p>
        </div>
      </div>
      {/* ********** section 5 ************** */}
      <div className="landing-body-wrapper-5">
        <h2 className="lb-5-h2">Some of our creations</h2>
